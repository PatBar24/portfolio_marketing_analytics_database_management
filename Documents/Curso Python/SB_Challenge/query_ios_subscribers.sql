...
--pregunta 2: Del total de trials, ¿Cómo es el share de trials por países?
...
group by 1;
 ...
 with commision as (SELECT DISTINCT country, customer_currency, sum(customer_price - developer_proceeds) 
